...
local function gameLoop()
	...
	for i = #asteroidsTable, 1, -1 do
		...
		if
			(thisAsteroid.x < -100 or thisAsteroid.x > display.contentWidth + 100 or thisAsteroid.y < -100 or
...
local function onCollision(event)
	if (event.phase == "began") then
		...
		if ((obj1.myName == "laser" and obj2.myName == "asteroid") or (obj1.myName == "asteroid" and obj2.myName == "laser")) then
			...
			scoreText.text = "Score: " .. score
		elseif
			((obj1.myName == "ship" and obj2.myName == "asteroid") or (obj1.myName == "asteroid" and obj2.myName == "ship"))
		 then
			if (died == false) then
				died = true
