...
function scene:create(event)
	...
	playButton:setFillColor(0.9, 0.8, 1)

	local highScoresButton = display.newText(sceneGroup, "High Scores", display.contentCenterX, 810, native.systemFont, 44)
	highScoresButton:setFillColor(0.8, 0.78, 1)

	menumusic = audio.loadStream("audio/Escape_Looping.wav")
...
function scene:show(event)
	...
	elseif (phase == "did") then
		audio.play(menumusic, {channel = 2, loops = -1})
